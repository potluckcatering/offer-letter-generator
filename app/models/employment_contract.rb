class EmploymentContract < ApplicationRecord
  ...
  has_settings do |s|
    s.key :offer_body, defaults: { 
      ...
      no_benefits: "Casual positions do not qualify for our company's extended medical plan. If you are eventually offered part-time or full-time classification, you would become eligible to participate in Potluck's Group Health & Dental Insurance Benefits Program after 6 months of continuous employment.",
      pt_benefits: "You are eligible to participate in Potluck's Part-time Group Basic Health & Dental Insurance Benefits Program after 6 months of continuous employment. Part Time benefits eligibility applies to those employees who continually work 15 to 23 hours per week.",
      ft_benefits: "You are eligible to participate in Potluck's SALARIED FULL-TIME Group Basic Health & Dental Insurance Benefits Program starting after 6 months of continuous employment.",
